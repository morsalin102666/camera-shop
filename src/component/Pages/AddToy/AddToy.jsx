                ...
                <form onSubmit={addToyForm}>
                    <div className="grid md:grid-cols-2 gap-8" >
                        <div>
                            ...
                            <input className="border px-3 py-3 w-full rounded-md" defaultValue={user && user.displayName} type="text" name="selarName" />
                        </div>
                        <div>
                            <label className="block mb-4 font-bold">Email</label>
                            <input className="border px-3 py-3 w-full rounded-md" defaultValue={user && user.email} type="text" name="email" />
                        </div>
                        <div>
                            <label className="block mb-4 font-bold">Name</label>
                            <input className="border px-3 py-3 w-full rounded-md" type="text" name="name" placeholder="Name" />
                        </div>
                        <div>
                            <label className="block mb-4 font-bold">Picture URL</label>
                            <input className="border px-3 py-3 w-full rounded-md" type="text" name="photoUrl" placeholder="Picture URL" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input className="border px-3 py-3 w-full rounded-md" type="text" name="price" placeholder="Price" />
                        </div>
                        <div>
                            <label className="block mb-4 font-bold">Rating</label>
                            <input className="border px-3 py-3 w-full rounded-md" type="text" name="rating" placeholder="Rating" />
                        </div>
                        <div>
                            <label className="block mb-4 font-bold">Available quantity</label>
                            <input className="border px-3 py-3 w-full rounded-md" type="text" name="quantity" placeholder="Available quantity" />
                        </div>
                    </div>
                    <div>
                        <label className="block my-4 font-bold">Detail description</label>
                        <textarea className="border px-3 py-3 w-full  h-[200px] rounded-md" placeholder="Detail description" name="description"></textarea>
                    </div>
                    <div className="mt-10">
